                ...
                try{
                    ...
                    if (username != null) {
                        ...
                        if (pathStrings.length > 2) {
                            ...
                            eventResult = jsonConverter.getEventResultJson(eventService.getEvent(pathStrings[2],username));

                        } else {
                            eventResult = jsonConverter.getEventsResultJson(eventService.getEvents(a));
                        ...
                        writeString(eventResult, respBody);
                        respBody.close();
                        success = true;
